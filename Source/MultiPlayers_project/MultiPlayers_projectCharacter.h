 ...
 */
UCLASS(abstract)
class AMultiPlayers_projectCharacter : public ACharacter
{
	GENERATED_BODY()
...
protected:
	...
	/** Called for valid damage input */
	void ValidDamage(const FInputActionValue& Value);

	/** Called for invalid damage input */
	void InvalidDamage(const FInputActionValue& Value);
